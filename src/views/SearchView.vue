<template>
  <div>
    <button v-show="btnActive" @click="pageTop" class="fixed right-5 bottom-10 bg-gray-900 opacity-70 rounded-2xl p-2">
      ...
      <div class="fixed w-screen border-2 border-red-400 top-10 bg-gray-300 z-50">
        <p class="mb-4">けんさく<input type="text" v-model="keyword" placeholder=" ここに国の名前をかいてね" class="ml-5 w-60"></p>
    ...
    <div class="m-10 mt-60 border-2 border-black p-5 bg-blue-200">
